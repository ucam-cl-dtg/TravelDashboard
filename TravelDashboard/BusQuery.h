...
@interface BusQuery : NSObject <BusLiveQueryDelegate>
@property (nonatomic, assign) id <SegmentQueryDelegate> delegate;
@property (nonatomic, strong) JourneySegment *journeySegment;
@property (nonatomic, strong) NSMutableArray *busTimeQueries;
@property (nonatomic, strong) NSMutableArray *busTimeResponses;
